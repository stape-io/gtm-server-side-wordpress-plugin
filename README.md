...
1. General plugin settings.
  ...
  <img alt="General plugin settings" src="images/readme/general-plugin-settings.png" width="850"/>

2. Data Layer settings.

  <img alt="Data Layer settings" src="images/readme/datalayer-settings.png" width="850"/>

3. Webhooks settings.

  <img alt="Webhooks settings" src="images/readme/webhooks-settings.png" width="850"/>

4. Menu item in the settings panel.

  <img alt="Plugin menu settings" src="images/readme/plugin-menu-settings.png" width="150"/>
